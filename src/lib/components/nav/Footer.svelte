<script>
	import MailSubscribe from '$lib/forms/MailSubscribe/MailSubscribe.svelte';
	...
	<div class="container mx-auto">
		...
		>
          ...
          -ms-interpolation-mode: nearest-neighbor`}
			...
			<div>
				<h2 class="mb-6 text-md font-semibold text-zinc-200 uppercase dark:text-white">Esports</h2>
				<ul class="text-gray-600 dark:text-gray-400 space-y-4 text-left">
					<li class="">
			...
			<div>
				<h2 class="mb-6 text-md  font-semibold text-zinc-200 uppercase dark:text-white">
					Documentation
				</h2>
